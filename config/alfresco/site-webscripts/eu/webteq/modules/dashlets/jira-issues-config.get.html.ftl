<div id="${args.htmlid}-configDialog" class="config-poll">
   ...
   <div class="bd">
      <form id="${args.htmlid}-form" action="" method="POST">
         ...
         <div class="yui-gd">
            <div class="yui-u first"><label for="${args.htmlid}-pageSize">${msg("label.resultsPerPage")}:</label></div>
            <div class="yui-u">
               <select id="${args.htmlid}-pageSize" name="pageSize">
         ...
         <div class="yui-gd">
         	<div class="yui-u first"><label for="${args.htmlid}-picker">${msg("label.display")}:</label></div>
         	<div class="yui-u">
